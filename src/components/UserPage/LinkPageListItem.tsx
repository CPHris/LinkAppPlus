  ...
  return (
    <div className="flex felx-row basis-1/3 justify-between items-center border-b p-5">
      ...
      <div className="w-full text-right">
        <Link
          href={`${props.userRoute}/edit/${pageid}`}
          className="px-1 border-solid border border-cyan-500 rounded mb-7 mr-3"
        >
          <i className="fa-solid fa-edit fa-xs text-cyan-500"></i>
        </Link>
